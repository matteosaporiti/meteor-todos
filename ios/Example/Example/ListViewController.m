...
- (void)didClickShareWithButton:(id)sender {
    ...
    [self.meteor callMethodName:@"/tasks/update" parameters:parameters responseCallback:nil];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle
    ...
    NSDictionary *list = self.lists[indexPath.row];
    [self.meteor callMethodName:@"/tasks/remove" parameters:@[@{@"_id": list[@"_id"]}] responseCallback:nil];
}
